...
const TocProgress = () => {
  ...
  let defaultOptions = {
      ...
      highlight_main:'{ background-color: white; color: black;}'
  };
  ...
  toc_progress.create=function()
  {
	  ...
	  for (var main_sections_index=1;main_sections_index<main_sections.length;main_sections_index++)
	  {
		  ...
		  var main_title_set = false;
		  {
			  ...
			  if (title_element!=null && (!title_element.hasAttribute('class') || title_element.getAttribute('class').indexOf('no-toc-progress')==-1))
			  {
				  ...
				  style_node.textContent=style_node.textContent+'.toc-progress-'+main_sections_index.toString()+' #toc-progress-'+main_sections_index.toString()+' '+this.highlight_main+'\n';
				  style_node.textContent=style_node.textContent+'html[class*="toc-progress-'+main_sections_index.toString()+'-"] #toc-progress-'+main_sections_index.toString()+' '+this.highlight_main+'\n';
  ...
  toc_progress.initialize=function(reducescroll,background,highlight_main)
  {
	  ...
	  this.highlight_main=highlight_main || '{font-weight: bold;}';
	...
	init: function( reveal ) {
	    deck = reveal;
	    let revealOptions = deck.getConfig().tocprogress || {};
	    let options = { ...defaultOptions, ...revealOptions };
	    toc_progress.initialize(options.reducescroll,options.background,options.highlight_main);
	    toc_progress.create();
	}
    }
}
